...
if($_GET) {
	...
	$mySql = "SELECT pengembalian.*, supplier.nm_supplier, user.nm_user 
				FROM pengembalian, supplier, user 
				WHERE pengembalian.kd_supplier=supplier.kd_supplier AND pengembalian.kd_user=user.kd_user 
				AND no_pengembalian='$noNota'";
...
<html>
<head>
<title>Cetak Pengembalian Barang</title>
...
<table width="600" border="0" cellspacing="1" cellpadding="4" class="table-print">
  <tr>
    <td width="139"><b>No. Pengembalian </b></td>
    <td width="5"><b>:</b></td>
    <td width="378" valign="top"><strong><?php echo $kolomData['no_pengembalian']; ?></strong></td>
  </tr>
  <tr>
    <td><b>Tgl.Pengembalian</b></td>
    <td><b>:</b></td>
    <td valign="top"><?php echo IndonesiaTgl($kolomData['tgl_pengembalian']); ?></td>
  </tr>
  <tr>
    <td><b>Supplier</b></td>
    <td><b>:</b></td>
...
<table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
$mySql ="SELECT pengembalian_detail.*, barang.nm_panjang, Jenis.nm_Jenis
		  FROM pengembalian_detail, barang, Jenis
		  WHERE barang.kd_Jenis=Jenis.kd_Jenis AND pengembalian_detail.kd_barang=barang.kd_barang 
		  AND pengembalian_detail.no_pengembalian='$noNota' ORDER BY pengembalian_detail.kd_barang";
